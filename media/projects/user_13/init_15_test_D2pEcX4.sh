...
APP_NAME="test"      # Used in API URL
MODELS_DATA="user:name,title;domaine:informatique,math;students:sarra,nesrine,maryem;intefaces:capture"    # Model name with fields

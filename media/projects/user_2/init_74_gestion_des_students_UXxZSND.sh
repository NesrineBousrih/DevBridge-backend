...
APP_NAME="gestion des students"      # Used in API URL
MODELS_DATA="user:name,title,matieres;domaine:informatique,math,physique;students:sarra,nesrine,maryem;matieres:informatique"    # Model name with fields

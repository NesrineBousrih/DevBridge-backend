...
APP_NAME="demo"      # Used in API URL
MODELS_DATA="api_project:id,project_name,model_name,date_creation,date_modification,framework_id,user_id,script_file,zip_file"    # Model name

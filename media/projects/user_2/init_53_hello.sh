...
APP_NAME="hello"      # Used in API URL
MODELS_DATA="api_project:id,project_name,date_creation,date_modification,framework_id,user_id,script_file,zip_file,tables"    # Model name with fields

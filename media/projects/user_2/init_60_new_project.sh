...
APP_NAME="new project"      # Used in API URL
MODELS_DATA="api_framework:id,name,logo,short_description,date_creation,date_modification,type;api_project:id,project_name,date_creation,date_modification,framework_id,user_id,script_file,zip_file,tables"    # Model name with fields

...
APP_NAME="demo2"      # Used in API URL
MODELS_DATA="user:name,title;sequence:rapport;domaine:informatique,math;students:sarra,nesrine,maryem"    # Model name with fields
